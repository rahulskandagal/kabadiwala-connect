...
CATS = [
    ...
    ("laptop", "Laptops / desktops", "लैपटॉप / कंप्यूटर", "लॅपटॉप / संगणक", "💻", 190, 0.010, "battery",
     ["laptop", "notebook", "desktop computer", "computer keyboard", "mouse", "space bar", "typewriter keyboard", "hard disc"]),
    ("pcb", "Circuit boards (PCB)", "सर्किट बोर्ड (PCB)", "सर्किट बोर्ड (PCB)", "🔌", 310, 0.015, "leach",
     ["modem", "radio", "oscilloscope", "cassette player", "tape player", "CD player", "digital clock", "joystick", "remote control", "switch"]),
